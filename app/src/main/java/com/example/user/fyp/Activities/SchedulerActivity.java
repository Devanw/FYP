...
import com.example.user.fyp.Schedule.AlarmReceiver;
import com.example.user.fyp.Schedule.LocalData;
import com.example.user.fyp.Schedule.NotificationScheduler;
        ...
        reminderSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    NotificationScheduler.cancelReminder(SchedulerActivity.this, AlarmReceiver.class);
                    ll_set_time.setAlpha(0.4f);
                }
